...
public class UserAppointmentsAdapter extends RecyclerView.Adapter<UserAppointmentsAdapter.AptView> {

    private Context context;
    private ArrayList<Appointment> appointments;
    AppointmentClickListenr apptClickListener;

    public UserAppointmentsAdapter(Context context, ArrayList<Appointment> appointments) {
