...
public class OOrderFrag extends Fragment implements MainActivityLogic.OOrdersView {
    OOrdersPresenter presenter;
    private Context context;
    private RecyclerView rv;
    private ProgressBar progressBar;
    private OOrdersAdapter ordersAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        context = getContext();
        presenter = new OOrdersPresenter(this,context);
        initObjects(view);
        return view;
    }
